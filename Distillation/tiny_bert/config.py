...
def set_args():
    ...
    parser.add_argument('--device', default='0', type=str, help='Indeks GPU, mis. 0')
    parser.add_argument('--num_train_epochs', default=10, type=str, help='Jumlah epoch pelatihan')
    parser.add_argument('--seed', type=int, default=42, help='Seed untuk reproduksibilitas')
    ...
    parser.add_argument('--alpha', type=float, default=0.3, help='Bobot komponen loss (jika dipakai)')
