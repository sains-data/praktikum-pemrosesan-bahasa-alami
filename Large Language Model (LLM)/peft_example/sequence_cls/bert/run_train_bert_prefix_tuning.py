"""
@file   : run_train_bert_prefix_tuning.py
@author : xiaolu
...
from peft import get_peft_model, PrefixTuningConfig, PeftType
...
if __name__ == '__main__':
    ...
    peft_config = PrefixTuningConfig(task_type="SEQ_CLS", num_virtual_tokens=20, peft_type=peft_type)
    lr = 1e-2
