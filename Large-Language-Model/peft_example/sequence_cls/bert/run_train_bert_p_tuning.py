"""
@file   : run_train_bert_p_tuning.py
@author : xiaolu
...
from peft import get_peft_model, PromptEncoderConfig, PeftType
...
if __name__ == '__main__':
    args = set_args()
    args.output_dir = './p_tuning'
    os.makedirs(args.output_dir, exist_ok=True)

    peft_config = PromptEncoderConfig(task_type="SEQ_CLS", num_virtual_tokens=20, encoder_hidden_size=128, peft_type=PeftType.PROMPT_TUNING)
    lr = 1e-3

    # Padding berbeda per arsitektur model
