...
def evaluateInput(encoder, decoder, searcher, voc):
    print("Chatbot seq2seq siap. Ketik 'q' atau 'quit' untuk keluar.")
    while True:
        try:
            input_sentence = input('Anda: ').strip()
            if input_sentence in ('q', 'quit', 'keluar'):
                break
            # Normalize sentence
            ...
            print("Kesalahan: kata tidak ada dalam kosakata.")
