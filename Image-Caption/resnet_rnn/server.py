...
def load_model():
    checkpoint = torch.load('./BEST_checkpoint_0.pth.tar', map_location='cpu')
...
def main():
    uploaded_file = st.file_uploader("Unggah gambar (JPG)", type="jpg")

    if uploaded_file is not None:
        # Konversi unggahan ke format OpenCV
...
if __name__ == '__main__':
    st.title('Demo Image Captioning — ResNet + LSTM')
