...
class EncoderRNN(nn.Module):
    """Encoder BiGRU: input (batch, seq_len) → output, hidden."""

    def __init__(self, input_size, hidden_size, n_layers=1):
        """input_size: ukuran kosakata; hidden_size: dimensi hidden."""
...
class AtteDecoderRNN(nn.Module):
    def __init__(self, hidden_size, output_size, n_layers=1, dropout_p=0.1, max_length=10):
        ...
        # Input attention: 2 arah × layer + embedding
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epoch):
        ...
        for e, f in dataloader:
            ...
            print("epoch:{}, step:{}, loss:{}".format(epoch, k, loss))
